...
/** The earlier implementation events the runtime never emits in v1; handlers register silently. */
...
export class TrustedExtensionRunner {
 ...
 // The compatibility alias: `registerProvider` accepts the same
 // plugin-owned shape as `registerAgent`, in both the original calls form
