...
export const zhCN = {
  ...
  tray: {
    ...
    open: "打开 dcode",
    quit: "退出 dcode",
    askTitle: "关闭后继续在后台运行 dcode？",
    askBody:
      "关闭窗口后，dcode 可以继续在系统托盘中运行，避免丢失任何内容。你随时可以在设置中更改此选项。",
    closeToTray: "关闭到托盘",
    confirmQuitTitle: "确定退出 dcode？",
    confirmQuitBody:
  ...
  chat: {
    ...
    scrollToTop: "滚动到顶部",
    jumpToLatest: "定位最新进度",
    viewExecutionInSidebar: "在侧边栏查看执行过程",
    actionWrite: "写入",
    actionTerminal: "终端",
    actionThinking: "思考",
    subagentActionRun: "运行",
    subagentActionRead: "读取",
    subagentActionThinking: "思考",
    subagentActionWrite: "写入",
    subagentActionWaiting: "等待",
    speakerYou: "你",
    speakerAssistant: "助手",
    ...
    usageBreakdownMcp: "MCP 工具",
    usageBreakdownOther: "其他",
    usageAverageCacheRate: "平均缓存命中率",
    ...
    waitingForSubagentNamed: "等待子智能体 {{name}} 执行",
    waitingForSubagents_one: "等待子智能体执行",
    waitingForSubagents_other: "等待 {{count}} 个子智能体执行",
    waitingForAgents: "等待智能体执行",
  ...
  plan: {
    ...
    approveAuto: "批准（安全托管）",
    approving: "正在批准…",
    autoWarning: "安全托管会直接运行 Bash，且可能修改文件。",
    reject: "拒绝",
    untitled: "未命名规划",
    openArtifact: "打开规划",
  },
  ...
  settings: {
    ...
    pluginProviderKeyHint: "保存在 dcode 中，由运行时使用。插件拿不到此密钥。",
    ...
    remoteHosts: {
      ...
      experimental: "实验性",
      controlTitle: "本机远控服务",
      controlDesc: "启动本机 RACP 服务后，可通过局域网手机或其它客户端远程控制本机 DCode。",
      controlEnable: "启用远控服务",
      controlStatus: "服务状态",
      controlRunning: "正在运行",
      controlStopped: "已停止",
      controlPort: "监听端口",
      controlAddresses: "本机局域网地址",
      controlPairingToken: "配对令牌 (Token)",
      controlPairingUrl: "完整连接地址",
      controlConnectedClients: "已连接设备数",
      controlRegenerateToken: "重新生成令牌",
      controlCopyToken: "复制令牌",
      controlCopyUrl: "复制连接串",
      controlTokenCopied: "令牌已复制到剪贴板",
      controlUrlCopied: "连接地址已复制到剪贴板",
    },
    importTitle: "从其他工具导入",
    importScan: "扫描",
    importScanning: "正在扫描…",
    ...
    permissionMode: "权限模式",
    permissionModeDesc: "工具操作的默认审批方式。安全托管会在不询问的情况下运行命令，并可能修改文件。单个会话里仍可临时调整。",
    permissionModeAsk: "每次询问",
    permissionModeAcceptEdits: "自动接受编辑",
    permissionModeAuto: "安全托管",
    ...
    network: "网络",
    proxy: "代理",
    proxyDesc: "HTTP、HTTPS 和 SOCKS5，用于模型请求、更新和内置浏览器。",
    proxySystem: "系统",
    proxyDirect: "直连",
    proxyCustom: "自定义",
    proxyUrl: "代理 URL",
    ...
    catalogStatusLine: "目录：{{source}} · {{models}} 个模型",
  ...
  plugins: {
    ...
    permissionHelp: {
      ...
      "provider.register": "把此插件定义的服务添加到设置的服务列表。接口地址和模型由插件提供，API 密钥则留在 dcode 中。",
      "desktop.control":
        "允许插件调用经过审查的 dcode 操作目录；破坏性操作仍需 confirm=true，插件永远拿不到 MCP bearer token。",
      ...
      "keyboard.globalShortcut": "注册系统级快捷键，在 dcode 未聚焦时触发本插件自己的命令。",
  ...
  extensions: {
    ...
    subagents: {
      ...
      presetResearcherName: "调研",
      presetResearcherDesc: "检索代码库，回答「在哪」和「怎么工作」。",
      presetReviewerName: "复核",
      presetReviewerDesc: "提交前检查正确性、边界情况和缺测。",
      presetTesterName: "测试",
      presetTesterDesc: "运行测试或构建，并报告失败原因。",
      presetCoderName: "开发",
      presetCoderDesc: "按规格实现多文件特性与代码改动。",
      presetDesignerName: "设计",
      presetDesignerDesc: "按需求稿设计并实现界面，浏览器预览验收。",
      presetExplorerName: "探索",
      presetExplorerDesc: "检索代码库，回答「在哪」和「怎么工作」。",
      presetTestRunnerName: "执行",
      presetTestRunnerDesc: "运行测试或构建，并报告失败原因。",
      presetFixerName: "修复",
      presetFixerDesc: "按规格实现跨文件改动。",
      presetUiDesignerName: "设计",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "当前 dcode 比本地数据更旧（数据库 schema {{found}}，此版本仅支持 {{supported}}）。请安装上次打开这些数据的更新版本，或更高版本。",
    archMismatch:
