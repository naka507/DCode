export const en = {
  ...
  updates: {
    title: "Updates",
    desc: "Updates are downloaded from the repository this build is configured with.",
    ...
    unconfigured: "This build has no release repository configured.",
  },
  nav: {
    "pinnedSessions": "Pinned",
    home: "Let every line of code arrive on schedule",
    newTask: "New task",
  ...
  chat: {
    ...
    viewExecutionInSidebar: "View execution process in sidebar",
    actionWrite: "Writing",
    actionTerminal: "Terminal",
    actionThinking: "Thinking",
    subagentActionRun: "Running",
    subagentActionRead: "Reading",
    subagentActionThinking: "Thinking",
    subagentActionWrite: "Writing",
    subagentActionWaiting: "Waiting",
    speakerYou: "You",
    ...
    usageBreakdownMcp: "MCP tools",
    usageBreakdownOther: "Other",
    usageAverageCacheRate: "Avg cache hit rate",
    ...
    subagentWorkUnnamed: "What the agent did",
    subagentProcess: "Activity",
    subagentUnnamed: "Agent",
    ...
    waitingForSubagentNamed: "Waiting for subagent {{name}} execution",
    waitingForSubagents_one: "Waiting for subagent execution",
    waitingForSubagents_other: "Waiting for {{count}} subagents execution",
    waitingForAgents: "Waiting for agent execution",
  ...
  settings: {
    ...
    remoteHosts: {
      ...
      controlTitle: "Local Remote Control Host",
      controlDesc: "Enable the local RACP service to remotely control this DCode instance from mobile or other LAN clients.",
      controlEnable: "Enable Remote Control",
      controlStatus: "Service Status",
      controlRunning: "Running",
      controlStopped: "Stopped",
      controlPort: "Port",
      controlAddresses: "LAN Addresses",
      controlPairingToken: "Pairing Token",
      controlPairingUrl: "Connection URL",
      controlConnectedClients: "Connected Devices",
      controlRegenerateToken: "Regenerate Token",
      controlCopyToken: "Copy Token",
      controlCopyUrl: "Copy URL",
      controlTokenCopied: "Pairing token copied to clipboard",
      controlUrlCopied: "Connection URL copied to clipboard",
    },
    ...
    proxy: "Proxy",
    proxyDesc:
      "HTTP, HTTPS, and SOCKS5 for model calls, updates, and the in-app browser.",
    proxySystem: "System",
    proxyDirect: "Direct",
    proxyCustom: "Custom",
    proxyUrl: "Proxy URL",
    ...
    catalogStatusLine: "Catalog: {{source}} · {{models}} models",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
  ...
  extensions: {
    ...
    subagents: {
      ...
      presetResearcherName: "Researcher",
      presetResearcherDesc: "Search the codebase and answer where or how questions.",
      presetReviewerName: "Reviewer",
      presetReviewerDesc: "A second look for correctness, edge cases, and missing tests.",
      presetTesterName: "Tester",
      presetTesterDesc: "Run a test or build command and report what failed.",
      presetCoderName: "Coder",
      presetCoderDesc: "Implement a multi-file feature or change from a spec.",
      presetDesignerName: "Designer",
      presetDesignerDesc: "Design and implement an interface from a brief, verified in the browser preview.",
