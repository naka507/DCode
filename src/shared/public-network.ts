 ...
 * stay free of that client's `node:dns` dependency — a pure module that cannot
 * import the client — classifies with this instead of importing the client.
 */
 ...
 * but want to explain it — a caller that surfaces the reason to the user —
 ...
 * hop on. Callers that must explain a block read this instead of parsing the
 * message.
 *
