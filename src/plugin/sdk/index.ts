...
export type PluginManifest = {
   ...
   * Local installs still enable after the user grants permissions.
   * permissions.
   */
...
/** Resolve a plugin label using the active dcode locale. */
export function resolvePluginLocalizedString(
  ...
  // ADR 0182: a plugin need not translate into every shell locale, and
  // Traditional Chinese reads the English entry rather than half a `zh-CN`
  // guess. Only the Simplified variants resolve to the Chinese catalog.
