 ...
 * `electron/main/remote/` that speaks the `@dcode/racp` protocol
 ...
 * `src/racp/test-harness.ts` so the adapter exercises the real
...
import { ErrorCodes, type RacpEventEnvelope } from "@dcode/shared";
