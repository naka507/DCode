...
import { IPC, type PluginScenicThemesDestinationMeta, type PluginViewMeta } from "@dcode/shared";
import { normalizeThemeAssetPath, pluginThemeId, resolvePluginLocalizedString, themeAssetUrl } from "@dcode/plugin-sdk";
