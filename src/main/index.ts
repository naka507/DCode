...
import { AppUpdaterController, RELEASE_ORIGIN } from "./updater";
...
const isDevelopmentBuild =
  process.env.DCODE_DEV === "1" || !app.isPackaged;
...
// `DCODE_DATA_DIR` still opts a run out of the lock (E2E, capture rig).
...
process.env.DCODE_DATA_DIR = dataDir;
...
const updater = new AppUpdaterController({
  logger,
  send: sendToRenderer,
  currentVersion: app.getVersion() || APP_VERSION,
