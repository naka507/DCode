 ...
 *
 * The map holds components, and the fallback is `null` so the caller
 * draws a lettered tile.
 */
...
const PLUGIN_VIEW_ICON_MAP: Record<string, Component> = {
  bell: IconBell,
  book: IconBookOpen,
  bot: IconBot,
  branch: IconBranch,
 ...
 */
export function pluginViewIcon(token: string | undefined): Component | null {
