/**
 * Presentation helpers for the session-collaboration hover card.
 *
 * Pure formatting/placement logic with no framework or store dependency.
 */
import type { SessionCollaborationSummary } from "@dcode/shared";
