/**
 * Composer model/mode/thinking constants and selection helpers.
 *
 * The module is framework-free, and its `../../../lib/session-thinking` import
 * resolves to `src/renderer/lib/session-thinking.ts`.
 */
import type {
  ModelInfo,
  Mode,
