/**
 * Store state declarations for the Vue renderer.
 *
 * The module imports no framework API, so nothing is substituted: the shared
 * types come from `@dcode/shared`, and every relative import
 * (`../lib/settings-search`, `../lib/transcript-reading`,
 * `../lib/sidebar-preferences`, ...) resolves from `src/renderer/`.
 */
import type {
  AgentEventEnvelope,
