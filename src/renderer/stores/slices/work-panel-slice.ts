/**
 * Work panel slice: the session-owned tool dock and subagent details.
 *
 * No framework API is used here: the width preference goes through the
 * `localStorage` key, and `../../lib/work-panel-*` are the other imports.
 */
