/**
 * Initial store state, before the first host bootstrap response.
 *
 * No framework API is used here: `./work-panel-slice` and
 * `../../lib/sidebar-preferences` are the only dependencies.
 */
