/**
 * Session title runtime: auto-title summarization and default-title detection.
 *
 * Translation goes through the vue-i18n instance in `../../i18n`
 * (`i18n.global.t(...)`). The legacy default-title set and the summarization
...
export function untitledTaskTitle(): string {
  return i18n.global.t("chat.untitledTask");
}
...
export function isDefaultSessionTitle(title?: string | null): boolean {
  ...
  return (
    ...
    trimmed === i18n.global.t("nav.newChat").toLowerCase()
  );
}
