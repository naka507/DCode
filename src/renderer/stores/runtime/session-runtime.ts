/**
 * Session runtime: transcript caches, navigation intents, configuration staging.
 *
 * The module imports no framework API; the cache limits, eviction order and
 * merge semantics are the whole contract.
 */
import type {
  AgentEventEnvelope,
  SessionSummary,
...
import { applyMessageUpdate } from "@dcode/shared";
