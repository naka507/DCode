/**
 * Canonical-input hydration for an explicit action on old history.
 *
 * The module is type-only apart from the store access it is handed;
 * `./session-runtime` and `../slices/types` are the renderer's declarations for
 * the shapes.
 */
