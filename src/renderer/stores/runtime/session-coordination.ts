/**
 * Session coordination: creating, forking and flushing sessions.
 *
 * No framework API is used here; the `../../lib/...` imports and
 * `../slices/work-panel-slice` are the only dependencies.
 */
import type {
