 ...
 *
 * Prereqs: `pnpm build:js`, `pnpm build:sidecar`, and a
 * host-core binary (target/debug or DCODE_HOST_BIN).
 */
...
import { RacpClient, wsClientTransport } from "../src/racp/index.ts";
...
const sidecar = join(root, "resources/runtime/sidecar.js");
