 ...
 *     subtree.
 *
 *  2. CHROME FAMILY RULE — the base rules of the chrome families tokenized in
 ...
 *     selector in the renderer: it catches a regression in a tokenized
 *     surface, not a brand-new literal on a selector nobody has reviewed yet.
 *
 ...
 *    (`src/renderer/lib/shiki.ts`: `THEMES = { light: "one-light",
