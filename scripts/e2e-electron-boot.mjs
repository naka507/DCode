 ...
 *
 * Prereqs: `pnpm --filter @dcode/desktop build` and a host-core binary
 * (target/debug or target/release, or DCODE_HOST_BIN).
 */
...
const dataDir = createTempDataDir("dcode-boot-");
...
const child = spawn(electronBin, ["."], {
  ...
  env: {
    ...
    DCODE_BOOT_PROBE: "1",
    DCODE_START_MAXIMIZED: process.platform === "darwin" ? "0" : "1",
