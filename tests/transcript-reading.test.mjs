...
const { createTranscriptReadingRuntime } = await import(
  "../src/renderer/stores/runtime/transcript-reading-runtime.ts"
);
const { transcriptViewMessages } = await import("../src/renderer/lib/transcript-reading.ts");
const { buildTranscriptEntries } = await import("../src/renderer/lib/assistant-turns.ts");
const { prepareTranscriptAction } = await import("../src/renderer/stores/runtime/transcript-action.ts");
