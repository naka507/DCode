...
import { capabilitiesFromModelConfig, modelConfigWithBinding } from "@dcode/agent-runtime";
register(new URL("./helpers/ts-import-hooks.mjs", import.meta.url));
const { createSessionLaunchRuntime } = await import("../src/main/runtime/session-launch.ts");
