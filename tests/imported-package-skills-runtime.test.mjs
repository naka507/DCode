...
const { generateImportedExtensionPlugin } = await import("../src/main/agent-extensions.ts");
const { PluginRuntime } = await import("../src/main/plugin-runtime.ts");
const hostEntry = fileURLToPath(new URL("../src/main/plugin-host-process.ts", import.meta.url));
