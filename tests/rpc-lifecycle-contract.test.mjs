...
const sidecarSource = await readFile(
  new URL("../src/engine/agent-sidecar.ts", import.meta.url),
  "utf8",
);
const runtimeSidecarSource = await readFile(
  new URL("../src/main/runtime/sidecar.ts", import.meta.url),
  "utf8",
);
...
const rpcTimeoutSource = await readFile(
  new URL("../src/shared/rpc-timeouts.ts", import.meta.url),
  "utf8",
);
...
const codexImporterSource = await readFile(
  new URL("../src/main/importers/codex.ts", import.meta.url),
  "utf8",
);
const apiSource = await readFile(
  new URL("../src/renderer/lib/api.ts", import.meta.url),
  "utf8",
);
