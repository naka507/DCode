...
const { API_STYLES } = await import("@dcode/shared");
const { CUSTOM_PROVIDER_API_STYLES, needsCustomApiStyleChoice, providerSetupPreset } =
  await import("../src/renderer/components/settings/provider-api-style.ts");
const { copyProviderConfiguration } = await import("../src/renderer/components/settings/provider-copy.ts");
