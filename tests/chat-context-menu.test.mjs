...
import { placeContextMenu } from "../src/renderer/lib/context-menu.ts";
import {
  conversationPlainText,
  copySelectionOrFallback,
} from "../src/renderer/lib/chat-transcript-text.ts";

/**
 * The transcript context menu's pure logic.
 *
 * The modules under test live in `src/renderer/lib/`.
 */
