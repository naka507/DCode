...
} from "../src/renderer/features/chat/transcript/menu-items.ts";

/**
 * The transcript context-menu vocabulary.
 *
 * The builders return `ContextMenuItem` data whose `icon` is a zero-prop
 * functional component, so the module imports cleanly under `node --test`.
 */
