...
import { clearTrustedExtensionCache, TrustedExtensionRunner } from "../../../src/agent/runtime/extensions/runner.js";
import type {
...
} from "../../../src/agent/runtime/extensions/index.js";
...
`,
  ...
  it("registerProvider is the same plugin-owned shape as registerAgent", async () => {
    // The compatibility alias takes a `complete` implementation as readily as a
