...
} from "../../src/agent/runtime/project-instructions.js";
import { projectInstructionsPrompt } from "../../src/agent/runtime/project-instructions-prompt.js";
...
describe("loadProjectInstructions", () => {
  it("loads a non-empty workspace-root AGENTS.md", async () => {
    root = await mkdtemp(join(tmpdir(), "dcode-instructions-"));
