...
const pluginAgentComplete = load("../src/main/plugin-agent-complete.ts", {
  "@dcode/agent-runtime": await import("@dcode/agent-runtime"),
  "@dcode/shared": await import("@dcode/shared"),
});

const { createSessionCollaborationService } = load("../src/main/services/session-collaboration.ts", {
  "node:crypto": crypto,
