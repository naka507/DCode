/**
 * Session model pinning helpers.
 *
 * The only change from the `7d92d961` revision of the same test is the import
 * path: `src/renderer/lib/session-model.ts`.
 */
...
} = await import("../src/renderer/lib/session-model.ts");
